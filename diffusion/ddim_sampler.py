...
from diffusion.beta_schedule import Beta_Schedule, get_named_beta_schedule, space_timesteps
...
from utils.enums_model import GenerativeType, LossType, ModelMeanType, ModelType, ModelVarType
...
class Gaussian_Diffusion:
    ...
    def sample(
        ...
        param = {"shape": shape, "noise": noise, "clip_denoised": clip_denoised, "model_kwargs": model_kwargs, "progress": progress}
